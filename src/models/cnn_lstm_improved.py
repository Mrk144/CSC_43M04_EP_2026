...
class CNNLSTMImproved(nn.Module):
    ...
    def __init__(self, num_classes: int, pretrained: bool=False, lstm_hidden_size: int=256, dropout_p: float=0.5, num_frames: int=0) -> None:
        super().__init__()
        ...
        self.lstm = nn.LSTM(input_size=feature_dim, hidden_size=lstm_hidden_size, num_layers=1, batch_first=True, bidirectional=True)
